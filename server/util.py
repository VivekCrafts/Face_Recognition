...
def classify_image(image_base64_data, file_path=None):
    ...
    for img in imgs:
        ...
        predicted_probabilities = np.around(__model.predict_proba(final) * 100, 2).tolist()[0]

        # Ensure the probabilities are matched to the correct class
        ...
        result.append({
            'class': class_name,
            'class_probability': predicted_probabilities,  # Already in percentage
...
if __name__ == '__main__':
    ...
    print(classify_image(None,"D:\\Sport celebraty FaceRecognition\\test\\sharapova1.jpg"))
